 ...
 *
 * Jalankan: php database/setup_nasabah.php
 */
...
try {
    ...
    foreach ($users as $u) {
        ...
        echo "   - User ID {$u[0]}: {$u[1]} ({$u[2]})\n";
    }

    // 2. Update nasabah table - CORRECTED: use table name 'nasabah'
    ...
    echo "\n=== Setup Complete ===\n";
    echo "\nLogin Test:\n";
    echo "  No HP: 081234567811 | Password: password123\n";
    echo "  No HP: 081234567812 | Password: password123\n";
    echo "  No HP: 081234567813 | Password: password123\n";
